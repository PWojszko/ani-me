...
import { Season, SeasonsList } from "@/vendor/jikan/jikanTypes";
...
const SeasonsPicker = ({ seasons }: SeasonsPickerProps) => {
  const [selectedYear, setSelectedYear] = useState(seasons.data[0].year);
  const [selectedSeason, setSelectedSeason] = useState<
    "winter" | "spring" | "summer" | "fall"
  >(seasons.data[0].seasons.slice(-1)[0]);
  ...
  return (
    <>
      ...
      <Cards seletedYear={selectedYear} selectedSeason={selectedSeason} />
    </>
  );
};
